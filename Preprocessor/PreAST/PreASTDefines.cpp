...
bool PreASTDefines::check_recursion(const Token &tok) const {
...
std::unordered_map<std::string, std::unique_ptr<PreNodeChunk>> PreASTDefines::get_substitution_vector(PreNodeDefineHeader* definition, const PreNodeDefineHeader* call) {
