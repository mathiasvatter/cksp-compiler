...
private:
    ...
    std::vector<std::tuple<std::string, std::string, CmdOptions, std::string>> m_option_tuples = {
            {"h", "help", CmdOptions::Help, "Display usage information"},
            {"o", "output", CmdOptions::Output, "Set output file name (default: <input_dir>/out.txt)"},
